        ...
        <div className="container">
            <div className="grid-header my-4">
                <div className="my-auto" >
                    ...
                    <p className="fs-3 light">Conceptos abarcados: periféricos de <span className="highlight">entrada</span>, <span className="highlight">salida</span> y <span className="highlight">mixtos.</span></p>
                </div>
                <div>
